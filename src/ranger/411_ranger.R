...
param  <- list( "num.trees"=      1708,  #cantidad de arboles
                "mtry"=             22,  #cantidad de variables que evalua para hacer un split  sqrt(ncol(dtrain))
                "min.node.size"=  293,  #tama̱o minimo de las hojas
                "max.depth"=        11   # 0 significa profundidad infinita
              )

set.seed(333333) #Establezco la semilla aleatoria
